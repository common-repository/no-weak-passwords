...
Version: 1.0.2
Plugin URI: https://wordpress.org/plugins/no-weak-passwords
...
define ('NOWEAKPASSWORDS_VERSION', '1.0.2');
...
// See WP's own use in https://svn.automattic.com/wordpress/tags/3.4/wp-includes/user.php
...
function no_weak_passwords_authenticate_login($user, $username, $password) {
	...
	// If no password given, then presume they are using some other login mechanism (and if they are not, WP will refuse the login anyway)
...
function no_weak_passwords_action_links($links, $file) {
	...
	if ( $file == NOWEAKPASSWORDS_SLUG."/".NOWEAKPASSWORDS_SLUG.".php" ){
		array_unshift( $links, 
			...
			'<a href="https://updraftplus.com">UpdraftPlus - Backup/Restore</a>',
			'<a href="https://david.dw-perspective.org.uk/donate">Donate</a>'
		);
	}
...
<div class="wrap">
	...
	Maintained by <strong>David Anderson</strong> (<a href="https://david.dw-perspective.org.uk">Homepage</a> | <a href="https://updraftplus.com">UpdraftPlus - Backup / Restore</a> | <a href="https://david.dw-perspective.org.uk/donate">Donate</a> | <a href="https://wordpress.org/plugins/no-weak-passwords/faq/">FAQs</a>)
	</p>

<div style="width:650px; float: left; margin-right: 20px;">
	<h2>Other great plugins and WordPress products</h2>

<p><strong><a href="https://updraftplus.com">UpdraftPlus (backup plugin)</strong></a><br>Automated, scheduled WordPress backups via email, FTP, Amazon S3 or Google Drive
</p>

<p><strong><a href="https://updraftcentral.com">UpdraftCentral (remote control plugin)</strong></a><br>Control multiple WordPress installs from a single dashboard
</p>

<p><strong><a href="https://www.simbahosting.co.uk/s3/shop">WooCommerce Premium Extensions</strong></a><br>Several popular WooCommerce add-ons</p>
...
<p><strong><a href="https://wordpress.org/plugins/use-administrator-password">Use Administrator Password (plugin)</strong></a><br>When installed, this plugin allows any administrator to use their own password to log in to any valid user's account. Very useful for logging in as another user without having to change passwords back and forth.</p>
...
Please either send a patch, or <a href="https://david.dw-perspective.org.uk/donate">make a donation on my donation page</a>, and I will be glad to help. Otherwise, this plugin does all I wanted it to do and I've not got time to develop it further without some compensation.</p>
</div>
